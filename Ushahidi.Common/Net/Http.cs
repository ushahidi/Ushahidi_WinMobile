...
namespace Ushahidi.Common.Net
{
    public sealed class Http
    {
        ...
        static readonly Hashtable entities;
        ...
        static Http ()
        {
            // Build the hash table of HTMLentity references.  This list comes
            // from the HTML 4.01 W3Crecommendation.
...
MemoryStream ();
        ...
        public static string UrlEncode (byte [] bytes, int offset, int count)
        {
            ...
            return Encoding.ASCII.GetString (UrlEncodeToBytes (bytes, offset, count), 0, bytes.Length);
        }
                ...
                switch (c)
                {
                    ...
                    case ';' :
                        ...
                        if (length >= 2 && entity[1] == '#' && entity[2] != ';')
                            ...
                            (length > 1 && entities.ContainsKey (entity.Substring (1, entity.Length - 2)))
