...
OutputDir=.
OutputBaseFilename=Ushahidi.WM6
...
Source: "Ushahidi.WM6.ini"; DestDir: "{app}"; Flags: ignoreversion
Source: "Ushahidi.WM6.CAB"; DestDir: "{app}"; Flags: ignoreversion

[Run]
FileName: {code:GetCEappManager}; Parameters: {code:GetIniFile|\Microsoft.NETCFv35.ini}
FileName: {code:GetCEappManager}; Parameters: {code:GetIniFile|\Ushahidi.WM6.ini}
